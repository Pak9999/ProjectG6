...
SELECT insert_article_with_geo_data(
    'Thailand', -- Place name
    'Svenskarnas semesterparadis', -- Under_title
    'Stark mat, stränder och annat trevligt.', -- Content
    'country', -- Geographical level
    7170000, -- Population
    513120, -- Land area
    NULL, -- Climate (region and city)
    4, -- ID of parent
	NULL -- Geo level of parent (city or region for POI)
);
